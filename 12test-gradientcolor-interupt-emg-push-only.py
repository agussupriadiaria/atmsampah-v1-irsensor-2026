...
def mainPage():
    ...
    #
    # Sekarang:
    # tinggi tombol = 75% dari tinggi sebelumnya
    # ==========================================================
    ...
    # ==========================================================
    # POSISI TOMBOL DI-CENTER TERHADAP KARTU
    #
    # Karena tombol sekarang lebih pendek, kita tambahkan
    # setengah selisih tinggi kartu dan tombol.
    # ==========================================================
