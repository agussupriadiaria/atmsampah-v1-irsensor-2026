...
unsigned long servo1CycleStartTime = 0;
...
void loop() {
  ...
  switch (currentState2) {
    case S2_IDLE:
      ...
      bool servo1AllowsServo2 =
          (currentState1 == S1_IDLE) ||
          ((currentState1 != S1_IDLE) && (millis() - servo1CycleStartTime >= 2000));

      if (button2PressedEvent && servo1AllowsServo2) {
