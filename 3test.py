...
def mainPage():
    ...
    total_btn_w = btn_w * 4 + spacing * 3
    start_x0 = left_x + (total_w - total_btn_w) // 2
    lama_x = start_x0
    mulai_x = lama_x + btn_w + spacing
    estruk_x = mulai_x + btn_w + spacing
    keluar_x = estruk_x + btn_w + spacing

    makeBtn(mainFrame, "Mulai Lama", "#0b5ed7", "#2f80ed", startPulseLama, lama_x, btn_y, btn_w, btn_h, bg_color=btn_bg)
    ...
    makeBtn(mainFrame, "Keluar", "#a01a1a", "#cc2828", closeWindow, keluar_x, btn_y, btn_w, btn_h, bg_color=btn_bg)
